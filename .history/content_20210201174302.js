var interval = setInterval(function () {
    ...
    Promise(function (resolve, reject) {
        setTimeout(function () { resolve(10000); }, 10000);
    });
    refreshPage();
}, 3000);
...
function refreshPage() {
    if (getElementByXpath("/html/body/div[1]/div/div[1]/div[2]/div/div[4]/div/div/a[6]/span/span/span[2]")) {
        ...
        console.log("Page refresh! No Job Yet.");
    } else {
...
function PlaySound() {
    ...
    return new Promise(function (resolve, reject) {
        setTimeout(function () { resolve(20000); }, 20000);
    });
}
...
//click //td[5]/div/div
function Step3() {
    if (document.getElementsByClassName('pdSubmissionBudgetJobInfoColumnRadioAccept')) {
        document.getElementsByClassName('pdSubmissionBudgetJobInfoColumnRadioAccept').click();
    } else {
        console.log("Element with classname starting 'pdSubmissionBudgetJobInfoColumnRadioAccept' not found");
    }
    console.log('Clicked on pdSubmissionBudgetJobInfoColumnRadioAccept');
    return new Promise(function (resolve, reject) {
        setTimeout(function () { resolve(200); }, 200);
    });
}
