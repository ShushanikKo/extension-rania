let repeatSteps = setInterval(refreshPage, 3000);
let continueSteps = setInterval(Steps, 3000);
...
function Steps() {
    tst = 3;
    console.log("T is:" + tst);
    if (tst == 3) {
        clearInterval(repeatSteps); //stop refreshing
        console.log("doing some shit here");
        let repeatSteps = setInterval(refreshPage, 3000);
    } else {
        tst++;
    }
    // check if any job appears, refresh till any does
    // full XPath is "/html/body/div[1]/div/div[1]/div[2]/div/div[3]/div/div[2]/table/tbody/tr/td[2]/div"
