...
//click //td[5]/div/div
function Step3() {
    if (document.getElementsByClassName('x-grid-radio-col-on')) {
        document.getElementsByClassName('x-grid-radio-col-on').click();
    } else {
        console.log("Element with classname starting 'x-grid-radio-col-on' not found");
    }
    console.log('Clicked on x-grid-radio-col-on');
    return new Promise(function (resolve, reject) {
        setTimeout(function () { resolve(200); }, 200);
    });
}
